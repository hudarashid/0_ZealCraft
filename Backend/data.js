...
const data = {
  ...
  stores: [
    {
      storeName: 'Rohan Store 1',
      storeDetail: 'First store of Rohan',
      bannerImage: '',
      additionalPhoto: '',
      supportEmail: 'rohan_store1@support.com',
      storeRating: 3.5,
      storeStatus: 'Active',
    ...
    {
      storeName: 'Rohan Store 2',
      storeDetail: 'Second store of Rohan',
      bannerImage: '',
      additionalPhoto: '',
      supportEmail: 'rohan_store2@support.com',
      storeRating: 2.5,
      storeStatus: 'Active',
