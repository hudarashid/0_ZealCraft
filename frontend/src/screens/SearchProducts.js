...
const SearchProducts = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const { data } = await axios.get(`/api/products/search?query=${query}&category=${category}&price=${price}`);
    ...
    return (
        <div>
            ...
            <Row style={{ textAlign: 'center', padding: '30px' }}>
                <h4 style={{ fontStyle: 'italic', fontWeight: '700', textDecoration: 'underline' }}>Search Product</h4>
            </Row>
            <Row>
